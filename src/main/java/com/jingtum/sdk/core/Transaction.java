...
public class Transaction extends JingtumObject {
	...
	/**
	 * Transaction type: sent, received, trusted, trusting, convert, offernew,
	 * offercancel, offereffect, accountset, jingtuming, failed
	 *
	 */
	public enum TranType {
		sent, received, trusted, trusting, convert, offernew, offercancel, offereffect, accountset, jingtuming, failed
	}
